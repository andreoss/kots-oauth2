...
class IntrospectionEndpointSpec extends CatsEffectSuite {
  ...
  private def code(result: Either[OAuth2Error, dev.oauth2.core.IntrospectionResponse]): Option[String] =
  ...
  ): IO[Either[OAuth2Error, dev.oauth2.core.IntrospectionResponse]] =
    endpoint(
